...
if __name__ == "__main__":
    ...
    triangle_points = [
        start_point,
        [start_point[0] + triangle_base, start_point[1], start_point[2]], # Front point
        [start_point[0] + (triangle_base/2), start_point[1], start_point[2] - triangle_height] # Top point
    ]
