...
void setup() {
  ...
  servo2.write(60);   // RR Hip
  servo3.write(120);  // RR Knee
  servo4.write(90);   // LR Shoulder
  servo5.write(120);  // LR Hip
  servo6.write(60);   // LR Knee
  servo7.write(90);   // FR Shoulder
  servo8.write(60);   // FR Hip
  servo9.write(120);  // FR Knee
  servo10.write(90);  // FL Shoulder
  servo11.write(120); // FL Hip
  servo12.write(60);  // FL Knee
}
